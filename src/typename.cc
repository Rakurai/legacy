...
String affect_loc_name(int location)
{
	...
	case APPLY_FORGE_UNIQUE:		return "increased forge success";
	case APPLY_PRIESTESS_UNIQUE:	return "increased healing power";
	case APPLY_BREW_UNIQUE:			return "increased brewing success";
