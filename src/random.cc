...
/**
 * @brief Pseudo-random distribution for percentage chance rolls obvious to the player.
 * @details Based on the DOTA2 system at:
 *
...
bool prd_chance(int *prev_fails, int percent) {
	...
	float cp = prd_table[percent] * ((*prev_fails) + 1);
