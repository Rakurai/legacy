...
/*	if ( ch->pcdata->security < 9 )
	{
		stc( "AEdit : Seguridad insuficiente para crear area.\n\r", ch );
		return;
	}
*/
	aedit_create( ch, "" );
...
/*
    if (!IS_BUILDER(ch,pArea))
    {
	stc("Insuficiente seguridad para editar areas.\n\r",ch);
	return;
    }
*/
...
void reset_room(ROOM_INDEX_DATA *room) {
    bug("reset_room: not yet implemented!", 0);
}
...
/*	if ( !IS_BUILDER( ch, pRoom->area ) )
	{
		stc( "Insuficiente seguridad para modificar cuartos.\n\r" , ch );
        	return;
	}
*/
	reset_room( pRoom );
	...
	if ( !pRoom )
	{
		stc( "REdit : cuarto inexistente.\n\r", ch );
		return;
	}
/*
	if ( !IS_BUILDER(ch, pRoom->area) )
	{
		stc( "REdit : insuficiente seguridad para editar cuarto.\n\r", ch );
		return;
	}
*/
	char_from_room( ch );
...
/*
    if ( !IS_BUILDER(ch, pRoom->area) )
    {
    	stc( "REdit : Insuficiente seguridad para editar cuartos.\n\r", ch );
    	return;
    }
*/
...
/*
	...
	{
		stc( "Insuficiente seguridad para modificar objetos.\n\r" , ch );
	        return;
	}
*/
...
/*
	...
	{
		stc( "Insuficiente seguridad para modificar mobs.\n\r" , ch );
	        return;
	}
*/
...
void do_resets( CHAR_DATA *ch, const char *argument )
{
	...
	stc( "        RESET <number> MOB <vnum> [max #x area] [max #x room]\n\r", ch );
	stc( "        RESET <number> DELETE\n\r", ch );
	stc( "        RESET <number> RANDOM [#x exits]\n\r", ch);
	}
    }
