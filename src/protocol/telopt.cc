...
void        debug_telopts            ( DESCRIPTOR_DATA *d, const unsigned char *src, int srclen );
int         process_do_eor           ( DESCRIPTOR_DATA *d, const unsigned char *src, int srclen );
int         process_will_ttype       ( DESCRIPTOR_DATA *d, const unsigned char *src, int srclen );
int         process_sb_ttype_is      ( DESCRIPTOR_DATA *d, const unsigned char *src, int srclen );
int         process_sb_naws          ( DESCRIPTOR_DATA *d, const unsigned char *src, int srclen );
int         process_will_new_environ ( DESCRIPTOR_DATA *d, const unsigned char *src, int srclen );
int         process_sb_new_environ   ( DESCRIPTOR_DATA *d, const unsigned char *src, int srclen );
int         process_do_charset       ( DESCRIPTOR_DATA *d, const unsigned char *src, int srclen );
int         process_sb_charset       ( DESCRIPTOR_DATA *d, const unsigned char *src, int srclen );
int         process_do_mssp          ( DESCRIPTOR_DATA *d, const unsigned char *src, int srclen );
int         process_do_msdp          ( DESCRIPTOR_DATA *d, const unsigned char *src, int srclen );
int         process_sb_msdp          ( DESCRIPTOR_DATA *d, const unsigned char *src, int srclen );
int         process_do_gmcp          ( DESCRIPTOR_DATA *d, const unsigned char *src, int srclen );
int         process_sb_gmcp          ( DESCRIPTOR_DATA *d, const unsigned char *src, int srclen );
int         process_do_mccp2         ( DESCRIPTOR_DATA *d, const unsigned char *src, int srclen );
int         process_dont_mccp2       ( DESCRIPTOR_DATA *d, const unsigned char *src, int srclen );
int         skip_sb                  ( DESCRIPTOR_DATA *d, const unsigned char *src, int srclen );
...
int         process_do_mccp3         ( DESCRIPTOR_DATA *d, const unsigned char *src, int srclen );
int         process_sb_mccp3         ( DESCRIPTOR_DATA *d, const unsigned char *src, int srclen );
...
struct telopt_type
{
	int      size;
	unsigned char   * code;
	int   (* func) (DESCRIPTOR_DATA *d, const unsigned char *src, int srclen);
};
...
int translate_telopts(DESCRIPTOR_DATA *d, const unsigned char *src, int srclen, unsigned char *out, int outlen)
{
	...
	{
		d->mth->mccp3->next_in   = (z_const unsigned char *)pti;
...
{
	d->mth->mccp2->next_in    = (z_const unsigned char *) txt;
