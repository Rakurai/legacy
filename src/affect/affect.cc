...
//		case APPLY_SAVES            	: duplicate with an older one
		...
		//beign unique gear
		case APPLY_FORGE_UNIQUE			: return APPLY_FORGE_UNIQUE;
		case APPLY_PRIESTESS_UNIQUE		: return APPLY_PRIESTESS_UNIQUE;
		case APPLY_BREW_UNIQUE			: return APPLY_BREW_UNIQUE;
		case APPLY_SCRIBE_UNIQUE		: return APPLY_SCRIBE_UNIQUE;
		case APPLY_TANK_UNIQUE			: return APPLY_TANK_UNIQUE;
		case APPLY_NECRO_PIERCE_UNIQUE	: return APPLY_NECRO_PIERCE_UNIQUE;
