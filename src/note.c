    ...
    if (pnote != NULL)
        {
            ...
            for ( pnote = *list; pnote != NULL; pnote = pnote->next)
            {
                if (!hide_note(ch,pnote))
                {
sprintf( buf, "{W[{PN{W: {x%3d{W] From:{x %s\n\r           {WTo: {x%s\n\r         {WDate: {x%s\n\r      {WSubject: {x%s\n\r",
                        vnum,
                        pnote->sender,
                        pnote->to_list,
                        pnote->date,
    ...
    if (pnote != NULL)
        {
            ...
            for ( pnote = *list; pnote != NULL; pnote = pnote->next)
            {
                if (!hide_note(ch,pnote))
                {
sprintf( buf, "{W[{YI{W: {x%3d{W] From:{x %s\n\r           {WTo: {x%s\n\r         {WDate: {x%s\n\r      {WSubject: {x%s\n\r",
                        vnum,
                        pnote->sender,
                        pnote->to_list,
                        pnote->date,
    ...
    if (pnote != NULL)
        {
            ...
            for ( pnote = *list; pnote != NULL; pnote = pnote->next)
            {
                if (!hide_note(ch,pnote))
                {
sprintf( buf, "{W[{GC{W: {x%3d{W] From:{x %s\n\r           {WTo: {x%s\n\r         {WDate: {x%s\n\r      {WSubject: {x%s\n\r",
                        vnum,
                        pnote->sender,
                        pnote->to_list,
                        pnote->date,
    ...
    if (pnote != NULL)
        {
            ...
            for ( pnote = *list; pnote != NULL; pnote = pnote->next)
            {
                if (!hide_note(ch,pnote))
                {
sprintf( buf, "{W[{BQ{W: {x%3d{W] From:{x %s\n\r           {WTo: {x%s\n\r         {WDate: {x%s\n\r      {WSubject: {x%s\n\r",
                        vnum,
                        pnote->sender,
                        pnote->to_list,
                        pnote->date,
    ...
    if (pnote != NULL)
        {
            ...
            for ( pnote = *list; pnote != NULL; pnote = pnote->next)
            {
                if (!hide_note(ch,pnote))
                {
sprintf( buf, "{W[{VR{W: {x%3d{W] From:{x %s\n\r           {WTo: {x%s\n\r         {WDate: {x%s\n\r      {WSubject: {x%s\n\r",
                        vnum,
                        pnote->sender,
                        pnote->to_list,
                        pnote->date,
    ...
    if (pnote != NULL)
        {
            ...
            for ( pnote = *list; pnote != NULL; pnote = pnote->next)
            {
                if (!hide_note(ch,pnote))
                {
sprintf( buf, "{W[{CP{W: {x%3d{W] From:{x %s\n\r           {WTo: {x%s\n\r         {WDate: {x%s\n\r      {WSubject: {x%s\n\r",
                        vnum,
                        pnote->sender,
                        pnote->to_list,
                        pnote->date,
    ...
    if (pnote != NULL)
        {
            ...
            for ( pnote = *list; pnote != NULL; pnote = pnote->next)
            {
                if (!hide_note(ch,pnote))
                {
sprintf( buf, "{W[{bT{W: {x%3d{W] From:{x %s\n\r           {WTo: {x%s\n\r         {WDate: {x%s\n\r      {WSubject: {x%s\n\r",
                        vnum,
                        pnote->sender,
                        pnote->to_list,
                        pnote->date,
