...
void          affect_update               args(( AFFECT_DATA *paf, const AFFECT_DATA 
*aff_template ));
...
String        affect_print_cache          args(( CHAR_DATA *ch ));
bool          affect_in_cache             args(( const CHAR_DATA *ch, sh_int sn ));
...
bool                affect_exists_on_char            args(( const CHAR_DATA *ch, int sn ));
