...
constexpr int MAX_DONATED = 8000; // max number of items in the pit, affects do_pit performance
...
constexpr int NEW_LAY_COUNTER = 12;
 ...
 * TO types for act.
 */
constexpr int TO_ROOM = 0;
constexpr int TO_NOTVICT = 1;
constexpr int TO_VICT = 2;
constexpr int TO_CHAR = 3;
constexpr int TO_ALL = 4;
constexpr int TO_WORLD = 5;
constexpr int TO_VIEW = 6;	/* for messages that need to go to the viewing room and don't normally */
constexpr int TO_NOTVIEW = 7;	/* messages that never go to the viewing rooms, otherwise TO_ROOM */
constexpr int TO_VICT_CHANNEL = 8;	/* special hack for channel vis, it's changed to normal vict later */
...
constexpr int TOKEN_WILD = 1;
constexpr int TOKEN_TRIVIA = 2;
constexpr int TOKEN_HIDDEN = 3;
constexpr int TOKEN_QUEST = 4; */
...
constexpr int SET_MAGE_INVOKER			 = 43; /*begin set defines*/
constexpr int SET_WARRIOR_BESERKER		 = 44; /*setting aside 43-63 for sets*/
...
constexpr Flags::Bit WIZ_BUGS                  = (Flags::V); /* W,X,Y open */
...
constexpr const char* AREA_LIST = "area.lst";  /* List of areas*/
 ...
 * Holiday specials
 */
constexpr bool HALLOWEEN = true;

/* for personally owned equipment */
constexpr const char* KEYWD_OWNER = "owned by";
