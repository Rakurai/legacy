...
STORAGE_DATA *lookup_storage_data(const String&);
...
String get_custom_color_name   args((CHAR_DATA *ch, int slot));
String get_custom_color_code   args((CHAR_DATA *ch, int slot));
